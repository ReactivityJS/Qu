...
// categories — Services (real, usable apps), Examples (developer-facing
// demo modules), Documentation (README, API, Whitepaper, interactive
// Lab, …) — see portal.mjs. Its INITIAL category (before any `#/...` hash
// exists yet) is chosen from `location.pathname` (portal.mjs's
// categoryFromPathname()), so visiting /services, /examples, or
// /documentation DIRECTLY — no hash, e.g. a bookmark or a link from
